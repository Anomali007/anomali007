...
📍 **Central Texas** | 🏗️ **Founder-Engineer at [The MASS Lab](https://themasslab.com)** | 🎰 **Lead Engineer · Beat The Odds**
...
[![GitHub Contribution Graph](https://ghchart.rshah.org/Anomali007)](https://github.com/Anomali007)
...
**Frontend:** React, Next.js (App Router & Pages), React Native/Expo, Tailwind CSS \
**Backend:** Node.js, tRPC, REST/GraphQL, Python, FastAPI, Serverless \
**Desktop:** Tauri v2, Rust, native macOS app packaging \
**Cloud/DevOps:** AWS (Lambda, ECS Fargate, Aurora, API Gateway, RDS, S3, Cognito, SES, ACM, CloudFront), SST v3, Vercel, GitHub Actions, Docker \
**Data:** PostgreSQL, DynamoDB, Aurora Serverless v2, Prisma/Drizzle ORM \
**AI/Automation:** Claude Code, Cursor, Bedrock, OpenAI APIs, Vapi, ElevenLabs, Deepgram, MCP \
**Security:** OAuth2/OIDC, RBAC, IAM Identity Center, secrets management, threat-aware design, CI quality gates

## Connect

[![Website](https://img.shields.io/badge/-anomali007.com-FF5722?style=flat-square&logo=google-chrome&logoColor=white)](https://anomali007.com)
[![The MASS Lab](https://img.shields.io/badge/-themasslab.com-E5A833?style=flat-square&logo=google-chrome&logoColor=white)](https://themasslab.com)
[![LinkedIn](https://img.shields.io/badge/-Mali_Franzese-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mali-franzese)
[![GitHub](https://img.shields.io/badge/-Follow-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Anomali007)
...
- 🏗️ 3,000+ commits across 20+ active repos
- 🤖 Built an AI developer platform with 11 slash commands, 6 agents, and 4 safety hooks
- 🦀 Learned Rust from scratch and shipped a native macOS app; now using it across Token Holder + Clawnoly
- ☕ Powered by Central Texas coffee and an unhealthy number of concurrent Claude sessions
- 🎓 ASU (1 yr EE) → Hack Reactor → WGU Cybersecurity (in progress) → lifelong builder
